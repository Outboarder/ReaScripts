--[[
Description: Remove Silence Join Gaps (Selected Items)
Instructions:
Screenshot: 
Version: 1.0
Author: Outboarder
...
function Remove_Gaps_Between_Selected_Items()
...
function Main()
	...
	Remove_Gaps_Between_Selected_Items()
	reaper.Undo_EndBlock("Remove_Gaps_Between_Selected_Items", 0)
end  
